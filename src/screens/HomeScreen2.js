        ...
        <View style={styles.content}>
          ...
          <View>
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('ProblemSolving')} // Navigate to ProblemSolving screen
            >
              ...
              <View style={styles.textContainer}>
                <Text style={styles.cardTitle}>Problem-Solving Lessons</Text>
                <Text style={styles.cardSubtitle}>
                  Learn effective strategies for tackling life's challenges
                </Text>
              </View>
            ...
            >
              ...
              <View style={styles.textContainer}>
                ...
                <Text style={styles.cardSubtitle}>
                  Identify the source of your stress and create a problem solving plan
                </Text>
              </View>
              <Ionicons name="chevron-forward" size={24} color="#4f7f6b" />
            </TouchableOpacity>
